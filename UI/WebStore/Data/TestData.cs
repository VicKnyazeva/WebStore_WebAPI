...
namespace WebStore.Data
{
    public static class TestData
    {
        ...
        {
            new Employee { Id = 1, LastName = "Васечкин", FirstName = "Петр", Patronymic = "Иванович", BirthDate = DateTime.Parse("11.11.1980") },
            new Employee { Id = 2, LastName = "Петров", FirstName = "Василий", Patronymic = "Григорьевич", BirthDate = DateTime.Parse("10.10.1975") },
            new Employee { Id = 3, LastName = "Иванов", FirstName = "Иван", Patronymic = "Петрович", BirthDate = DateTime.Parse("12.12.1970") }
        };
